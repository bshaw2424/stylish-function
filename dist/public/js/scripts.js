...
const messageDeleteButtons = document.querySelectorAll(".message-delete-button .material-icons");
const collection_items = document.querySelectorAll(".collection-item"); //const articleForm = document.querySelector(".article-form");
